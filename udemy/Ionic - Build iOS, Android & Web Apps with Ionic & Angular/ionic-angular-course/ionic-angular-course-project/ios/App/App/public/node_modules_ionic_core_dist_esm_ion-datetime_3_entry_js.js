...
let Datetime = class {
  ...
  renderTimeOverlay(hoursItems, minutesItems, ampmItems, use24Hour) {
    ...
    return [(0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      "aria-haspopup": "true",
      onClick: function () {
        var _ref = (0,_Users_user_myDevelop_self_study_udemy_Ionic_Build_iOS_Android_Web_Apps_with_Ionic_Angular_ionic_angular_course_ionic_angular_course_project_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
          const {
            popoverRef
          } = _this4;
